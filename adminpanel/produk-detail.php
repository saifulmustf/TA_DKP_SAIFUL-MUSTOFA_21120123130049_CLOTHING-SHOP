        ...
        <div class="col-12 col-md-6 mb-5">
            ...
            <form>
                ...
                <?php
                            ...
                            $queryUpdate = mysqli_query($con, "UPDATE produk SET kategori_id='$kategori', nama='$nama',
                            harga='$harga', detail='$detail', ketersediaan_stock='$ketersediaan_stock' WHERE id=$id");
